...
I'm a Senior Product Manager with a focus on data platforms, pipelines, and martech/fintech SaaS. I build tools I wish existed.

Most PMs write about building things. I occasionally just build them.

---

## What's here

The repos pinned below fall into two categories:
...
## Why a PM builds tools

Two reasons.

First, the practical one: I spend a lot of time working with engineers and data teams. Being able to build a working prototype — even a rough one — changes the nature of that conversation. It's easier to discuss trade-offs when you've felt them yourself.

Second, the product one: the best way to understand a user's problem is to be the user. Every tool here started as something I needed and couldn't find. The resume analyser came out of a job search. The data utilities came out of real pipeline work. Building them taught me things I wouldn't have learned any other way.

---

## Background

I've spent my career at the intersection of data and product — owning core platform capabilities at companies including Optimizely, Diligent, Clearpool, and Nasdaq. I care about data integrity, platform reliability, and building things that actually get used.

📍 New York City &nbsp;|&nbsp; [LinkedIn](https://linkedin.com/in/michaelfehle) &nbsp;|&nbsp; michael.fehle@protonmail.com
